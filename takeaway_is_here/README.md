...
If you are not sure where to click first:
如果你不知道先点哪里：

1. open `OPEN_HOME.html`
2. check `distilled_entries/`
3. read this file if you forget the boundary

## Folder Meaning / 文件夹含义

- `distilled_entries/`
  - your working takeaway outputs
- `implementation_briefs/`
  - handoff notes for build/design execution
- `assets/`
